                    ...
                    <?php
                      ...
                      if ($tags) {
                        ...
                        if ( $my_query->have_posts() ) : 
                          echo '<aside class="widget relatedposts"><section><h3>'.__('Related posts','nabasic').'</h3>';
                          while( $my_query->have_posts() ) {
                            ...
                            ?>
                              <article class="clearfix">
                                ...
                                <?php endif; ?>
                                <h5><a rel="external" href="<? the_permalink()?>"><?php the_title(); ?></a></h5>
                                <?php echo na_the_excerpt('25'); ?>
                              </article>
                          <? }
                          echo '<section></aside>';
                        endif;
